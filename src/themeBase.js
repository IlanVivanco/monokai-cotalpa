...
export const themeBase = {
	...
	colors: {
		...
		'activityBar.inactiveForeground': theme.midtone,
		...
		'sideBarTitle.foreground': theme.midtone,
		...
		'editor.selectionForeground': theme.strings,
		...
		'tab.inactiveBackground': chroma(theme.dimmedBackground).alpha(0.5).hex(),
		'tab.unfocusedInactiveBackground': chroma(theme.dimmedBackground).alpha(0.5).hex(),
		'tab.inactiveForeground': theme.midtone,
		'tab.unfocusedActiveForeground': theme.darkForeground,
		'tab.unfocusedInactiveForeground': theme.midtone,
		...
		'tab.hoverBorder': theme.midtone,
		'tab.unfocusedHoverBorder': theme.background,
		'tab.activeModifiedBorder': theme.midtone,
		'tab.inactiveModifiedBorder': theme.midtone,
		...
		'editorLineNumber.activeForeground': theme.mutedForeground,
		'editorLineNumber.foreground': theme.midtone,
		...
		'editorRuler.foreground': theme.midtone,
		...
		'editorWhitespace.foreground': theme.midtone,
		...
		'extensionButton.prominentHoverBackground': theme.midtone,
		...
		'gitDecoration.ignoredResourceForeground': theme.midtone,
		...
		'inputOption.activeBackground': theme.midtone,
		'inputOption.activeBorder': theme.midtone,
		...
		'peekViewEditor.matchHighlightBackground': theme.midtone,
		...
		'peekViewResult.matchHighlightBackground': theme.midtone,
		...
		'pickerGroup.foreground': theme.midtone,
